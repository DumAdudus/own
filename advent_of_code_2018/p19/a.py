...
ip = 3
reg = Reg(0, 10551292, 3, 10551292, 0, 1)
reg = Reg(1, 10551292, 3, 5275646, 0, 2)
reg = Reg(3, 10551292, 3, 2637823, 0, 4)
reg = Reg(7, 10551292, 3, 172972, 0, 61)
reg = Reg(68, 10551292, 3, 127124, 0, 83)
reg = Reg(3203094, 10551292, 3, 2, 0, 5275646)
reg = Reg(8478740, 10551292, 3, 1, 0, 10551292)

ip = 9
# reg = Reg(3, 10551292, 9, 10551293, 0, 2)
# reg = Reg(3, 10551292, 9, 10551293, 0, 3)
# reg = Reg(7, 10551292, 9, 10551293, 0, 4)
# reg = Reg(68, 10551292, 9, 10551293, 0, 82)
# reg = Reg(151, 10551292, 9, 10551293, 0, 83)
# reg = Reg(13754409, 10551292, 9, 10551293, 0, 5275646)
reg = Reg(19030032, 10551292, 9, 10551293, 0, 10551292)

# ip = 13
# reg = Reg(13754409, 10551292, 13, 10551293, 1, 10551293)


while True:
    cur_op = oplist[ip]
    reg.set(str(ip_reg), ip)
    nreg = cur_op.run(reg)
    print "ip:", ip, reg, cur_op, nreg
    ip = nreg.get(str(ip_reg))
    ip += 1
    if ip >= len(oplist):
        break
    reg = nreg
